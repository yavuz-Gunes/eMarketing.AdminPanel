...
public interface IStockRepository
{
    ...
    Task<IReadOnlyList<StockMovementDto>> GetCentralMovementsAsync(int productId, int count, int? userId, bool isAdmin, CancellationToken cancellationToken = default);

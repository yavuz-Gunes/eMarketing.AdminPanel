...
public sealed class DealerService : IDealerService
{
    ...
    {
        return _repository.GetStoreByIdAsync(storeId, cancellationToken);
    }
    ...
    {
        return _repository.UpdateStoreAsync(storeId, request, cancellationToken);
    }

    public Task SetStoreStatusAsync(int storeId, bool active, CancellationToken cancellationToken = default)
    {
        return _repository.SetStoreStatusAsync(storeId, active, cancellationToken);
    }
}
